...
const mockPolicies = [
  ...
  },
  {
    ...
    section_identifier: 'Section 1',
    paragraph_identifier: '1',
    policy_text: 'High-risk AI systems shall be designed and developed in such a way to ensure that their operation is sufficiently transparent to enable users to interpret the systems output and use it appropriately.',
  ...
  },
  {
    ...
    paragraph_identifier: '1',
    point_identifier: 'a',
    policy_text: 'The placing on the market, putting into service or use of an AI system that deploys subliminal techniques beyond a persons consciousness in order to materially distort a persons behaviour in a manner that causes or is likely to cause that person or another person physical or psychological harm is prohibited.',
